...
class TextSummarizationTask(Task):
    ...
    def __init__(self, task, model, **kwargs):
        ...
        self._use_fast_tokenizer = kwargs.get("use_fast_tokenizer", False)
        ...
        self._length_penalty = kwargs.get("length_penalty", 0.7)
    ...
    def _construct_tokenizer(self, model, **kwargs):
        """
