python train.py \
    ...
    --save_dir=checkpoints/human_activity/Randeng-Pegasus-238M-Summary-Chinese \
    --init_checkpoint=checkpoints/human_activity/Randeng-Pegasus-238M-Summary-Chinese/model_best \
